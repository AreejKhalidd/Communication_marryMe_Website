...
export default {
  ...
  methods: {
    getUserInfo() {
      ...
      const option = {
        headers: {
          Authorization: `${"Bearer"} ${"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC8xMjcuMC4wLjE6ODAwMFwvYXBpXC9sb2dpbiIsImlhdCI6MTYzMjIwNjM2NywiZXhwIjoxNjMyNDM2NzY3LCJuYmYiOjE2MzIyMDYzNjcsImp0aSI6Im9sRlJmbDFGMGVlNlFaVm4iLCJzdWIiOjEsInBydiI6IjIzYmQ1Yzg5NDlmNjAwYWRiMzllNzAxYzQwMDg3MmRiN2E1OTc2ZjcifQ.6IY60WgyT9A-H8vsT28O9tniOz04zl0fBprVtF37MAw"}`,
        },
