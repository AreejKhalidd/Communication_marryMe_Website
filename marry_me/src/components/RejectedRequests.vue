...
<template>
  ...
  <v-card v-if="status === 2" :id="id" style="background-color: white;margin:15px;direction: rtl" class="mx-auto">
        ...
        <v-list-item style="max-width: 1300px">
          ...
          <div class="text-center">
            <template>
              ...
              <v-btn
                  @click="decision(id,sender_id,1)"
                  style="background-color: green;margin-right: 10px;color: #EEEEEE;margin-bottom: 5px" depressed>
                قبول
              </v-btn>
              <v-icon
