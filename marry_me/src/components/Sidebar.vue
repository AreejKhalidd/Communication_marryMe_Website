            ...
            <b-nav vertical >
                <v-img
                    ...
                    >
                                    ...
                                    <h5 style="color: #FE6265;font-size: 20px; margin-right:9px; margin-top:2px;"> {{name}} </h5>
                <v-divider></v-divider>
                <v-list-item to="favUsers"  >
                  <font-awesome-icon style="color: #FE6265;font-size: 40px;margin-left:auto; margin-right:7px;" :icon="fav"/> 
                  <span class="link" style="text-align:center;margin-left:auto;"> قائمة المعجب بهم</span>       
                </v-list-item>  
                <v-list-item to="blockedUsers"  >
                  <font-awesome-icon style="color: #FE6265;font-size: 40px;margin-left:auto; margin-right:7px;" :icon="block"/> 
                  <span class="link" style="text-align:center;margin-left:auto;">قائمة المحظورين</span>    
                </v-list-item>  
                <v-list-item to="allRequests"  >
                  <font-awesome-icon style="color: #FE6265;font-size: 40px;margin-left:auto; margin-right:7px;" :icon="req"/> 
                  <span class="link" style="text-align:center;margin-left:auto;">قائمة طلبات الصداقة</span>    
                </v-list-item>  
                <v-list-item to="followersList" v-if="VIP === 1 "  >
                  <font-awesome-icon style="color: #FE6265;font-size: 40px;margin-left:auto; margin-right:7px;" :icon="favme"/>     
                  <span class="link" style="text-align:center;margin-left:auto;">قائمة المعجبين بي</span>
                </v-list-item> 
                <v-list-item to="certifyme" >
                  <font-awesome-icon style="color: #FE6265;font-size:40px;margin-left:auto; margin-right:7px;" :icon="certify"/>  
